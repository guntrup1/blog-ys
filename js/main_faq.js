...
$('.page-faq__inner-quastion-1').click(function(event) {
	$('.page-faq__inner-quastion_text-1, .page-faq__inner-quastion-1').toggleClass('active');
});

$('.page-faq__inner-quastion-2').click(function(event) {
	$('.page-faq__inner-quastion_text-2, .page-faq__inner-quastion-2').toggleClass('active');
});

$('.page-faq__inner-quastion-3').click(function(event) {
	$('.page-faq__inner-quastion_text-3, .page-faq__inner-quastion-3').toggleClass('active');
});

$('.page-faq__inner-quastion-4').click(function(event) {
	$('.page-faq__inner-quastion_text-4, .page-faq__inner-quastion-4').toggleClass('active');
});

$('.page-faq__inner-quastion-5').click(function(event) {
	$('.page-faq__inner-quastion_text-5, .page-faq__inner-quastion-5').toggleClass('active');
});

$('.page-faq__inner-quastion-6').click(function(event) {
	$('.page-faq__inner-quastion_text-6, .page-faq__inner-quastion-6').toggleClass('active');
});
